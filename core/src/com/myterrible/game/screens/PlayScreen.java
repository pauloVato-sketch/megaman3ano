...
public class PlayScreen extends MapScreen implements Screen {
	...
	public PlayScreen(Megaman game) {
		...
		map = mapLoader.load("maps_itens/mapa1/FASE_1.tmx");
		...
		player = new MegaPlayer(this,32,700);
		player.tiro = new Shot(world,this,player,player.correndoDireita);
		enemy = new Terrestres(this, 132, 700);
		enemy2 = new Terrestres(this,1800,150);
