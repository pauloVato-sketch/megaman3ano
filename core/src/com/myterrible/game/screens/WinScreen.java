...
public class WinScreen implements Screen {
	...
	public WinScreen(final Megaman game) {
		gameSave = game;
	...
	public void show() {
        ...
        mainTable.right();
        mainTable.bottom();
        texture = new Texture(Gdx.files.internal("img/youwin.jpg"));
        ...
        playButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                ((Game)Gdx.app.getApplicationListener()).setScreen(new MenuScreen(gameSave));
            }
        });
